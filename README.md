...
- Download ZIP: You can go to the [starter-files branch](https://github.com/RepoWanderer/Brainwave_Matrix_Intern) and download the starter files as a ZIP archive.
...
1. Clone the repository to your local machine:
   ...
   ```bash
   git clone https://github.com/RepoWanderer/Brainwave_Matrix_Intern.git
...
2. Enter your User ID and PIN to log in. (For demonstration purposes, User ID: `1000`, PIN: `121314`)
...
[Give a Star]([(https://github.com/RepoWanderer/Brainwave_Matrix_Intern)])
...
<div align="center">
  ...
  <img src="https://github.com/RepoWanderer/Brainwave_Matrix_Intern" alt="Happy Hacking" width="200">
